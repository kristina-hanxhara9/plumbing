...
Usage:
    ...
    python fetch_market_data_v3.py --no-ssl-verify
"""
import argparse
import io
import logging
...
def _fetch_ons_via_api():
    ...
    # Download via requests to respect SSL_VERIFY, then parse
    resp = requests.get(csv_url, timeout=60, verify=SSL_VERIFY)
