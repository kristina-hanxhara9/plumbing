"""Find plumbing merchants from Companies House — full details + confidence.
...
Usage:
    ...
    python find_plumbing_merchants.py --skip-profiles   # faster, advanced search data only
"""
import argparse
import logging
import os
...
TOP_KEYWORDS = ["plumb", "heating", "supplies"]
...
CONFIDENCE_WEIGHTS = {
    "has_top3_sic": 0.30,       # Has one of the top 3 SIC codes
    ...
    "name_supplies": 0.10,      # Name contains "supplies"
    "name_merchant": 0.05,      # Name contains "merchant"
    "name_wholesale": 0.05,     # Name contains "wholesale"
...
def compute_confidence(row):
    ...
    if "wholesale" in name_lower:
        score += CONFIDENCE_WEIGHTS["name_wholesale"]
